...
(function (exports) {
    ...
    exports.plot = function (series, cfg = undefined) {
        ...
        let ratio   = range ? (height / range) : (cfg.height || 1)
        ...
        for (let y = min2; y <= max2; ++y) { // axis + labels
            let label = range ? format (max - (y - min2) * range / rows, y - min2) : format (max)
...
}) (typeof exports === 'undefined' ? /* istanbul ignore next */ this['asciiplot'] = {} : exports);
